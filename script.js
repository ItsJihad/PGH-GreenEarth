...
ButtonCreator = (buttonData) => {
  ...
  buttonData.forEach((button) => {
    ...
    categorybutton.classList =
      "categorybuttons  m-2 sm:m-0 bg-[#F0FDF9] px-2.5 py-2 font-medium font-['Inter'] text-black rounded hover:bg-green-200 ";
...
cardsCreator = (cardData) => {
  cardData.forEach((card) => {
    ...
    pricer(card.name,card.price,document.querySelectorAll(".productName"))
...
const mangoQuantity = document.getElementById("mangoQuantity")
